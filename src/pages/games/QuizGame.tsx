...
const QUESTIONS: Question[] = [
  ...
  { q: "Как считались голоса на SLAY 2025 (орган. WINLINE)?", options: ["100% жюри стримеров", "70% зрители 13–27.11 на сайте +30% жюри", "50/50 зрители+жюри", "100% зрители на сайте"], correct: 1, fact: "SLAY 2025: 70% голоса зрителей 13–27 ноября на сайте +30% жюри стримеров. Церемония 03.12.2025 Дворец Ирины Винер (Лужники, Москва) при WINLINE — статуэтки WINLINE SLAY. Номинация Minecraft-стример года впервые. Источники: gamemag.ru/news/196845 + championat.com/news-6267700 + esports.ru." },
  ...
  // ── СЛАВА БОССУ манифест 11.12.2025 — yt-2026-09-01-2320 карточка 13 — ZeIFBdoOZXo VTT 1765 симв. frag 2-9 — Угадай трек по цитате + Шрек из Ростова — без выдумок
  { q: "Угадай трек по цитате: «Я никогда не был хорошим примером… Со мной моё племя»", options: ["СЛАВА БОССУ (SLAY DISS) — 11.12.2025", "Казино — 22.10.2025", "Пожарники — 02.04.2026", "VPN — 27.04.2026"], correct: 0, fact: "СЛАВА БОССУ 11.12.2025 (ФУГА TV, 370k/23k, 3:07, нейро-клип outsideinclub) — VTT-манифест 1765 симв. frag 2-9: «Я никогда не был хорошим… Этот выбор единственно верный… Мой путь от майнкрафтовой эры. До признания всех ваших премий. Пришло моё время. Со мной моё племя.» — далее рефрен «Слава боссу» + «Шрек из Ростова будет коронован». Источник: https://www.youtube.com/watch?v=ZeIFBdoOZXo" },
  { q: "Кто будет коронован по версии СЛАВА БОССУ?", options: ["Шрек из Ростова", "Принц из Москвы", "Король из Питера", "Босс из Кемерово"], correct: 0, fact: "«Шрек из Ростова будет коронован» — финал манифеста СЛАВА БОССУ 11.12.2025 (Ростов-на-Дону — родина 5opka 05.04.1996). Источник: VTT ZeIFBdoOZXo.ru.vtt, transcript:true." },
  { q: "Какой рефрен открывает СЛАВА БОССУ (14 повторов на интро)?", options: ["Слава боссу", "Слава SLAY", "Слава 42", "Слава Ростова"], correct: 0, fact: "Интро: ≈14 повторов «бос, бос, бос… 42» → рефрен «Слава боссу» / «Слава, слава, слава боссу» — коронный мем трека. Источник: VTT ZeIFBdoOZXo 00:00-00:16." },
  // ── ПУШКА интервью 16.08.2025 — yt-2026-09-01-2320 карточка 14 — _D_BZuqM_eE 83:11 62k VTT 919K 1652 симв. — сливки общества + 42.000 просмотров — Угадай подарок
